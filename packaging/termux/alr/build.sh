...
TERMUX_PKG_SHA256=PLACEHOLDER-fill-after-the-v0.4.3-release-job-publishes
...
_PRELOAD_TARBALL_SHA256="PLACEHOLDER-fill-after-the-v0.4.3-release-job-publishes"
